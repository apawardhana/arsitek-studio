...
export default function TeamContent({ initialTeam }: TeamContentProps) {
    const leadership = initialTeam.filter(m => m.department.toUpperCase() === "LEADERSHIP");
    const others = initialTeam.filter(m => m.department.toUpperCase() !== "LEADERSHIP");
