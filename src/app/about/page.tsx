        ...
        <>
            ...
            <section className="relative h-[60vh] min-h-[500px] flex items-end overflow-hidden">
                ...
                <div className="container-custom relative z-10 pb-16 lg:pb-24">
                    ...
                    <AnimatedText
                        text="Crafting architectural excellence since 1999"
                        tag="h1"
                        ...
                        <div>
                            ...
                            <FadeIn delay={0.2}>
                                <div className="space-y-6 text-foreground-muted leading-relaxed">
                                    ...
                                    <p>
                                        Today, our multidisciplinary team of architects, engineers,
                                        and designers works across borders, bringing Indonesian design
                                        sensibility to the global stage while embracing the best of
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24">
                        <FadeIn>
                            ...
                            <h3 className="font-serif text-3xl md:text-4xl font-light mb-6">
                                To be the leading architectural practice in Southeast Asia
                            </h3>
                            <p className="text-foreground-muted leading-relaxed">
                                We envision a future where our designs set the standard for
                                sustainable, human-centered architecture across the region and
                                beyond.
                            </p>
                        </FadeIn>
                        <FadeIn delay={0.2}>
                            ...
                            <p className="text-foreground-muted leading-relaxed">
                                Through innovative design, sustainable practices, and
                                collaborative partnerships, we create architectural solutions
                                that enhance the quality of life for all who experience our
                                spaces.
                            </p>
                        </FadeIn>
                    </div>
