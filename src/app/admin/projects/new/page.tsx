            ...
            <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-6 space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <FormField label="Slug" required error={errors.slug} description="URL-friendly identifier">
                            <Input
                                name="slug"
                                value={formData.slug}
                                onChange={handleChange}
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-6 space-y-6">
                    ...
                    <div className="pt-4 border-t border-gray-100">
                        <FormField label="Project Gallery" description="Additional images for the project (optional)">
                            <GalleryUpload
                                images={images}
                                onChange={setImages}
                            />
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-6 space-y-6">
                    ...
                    <FormField label="Meta Title" description="Leave empty to use project title">
                        <Input
                            name="metaTitle"
